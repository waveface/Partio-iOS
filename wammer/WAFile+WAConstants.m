...
NSString * const kWAFileSmallThumbnailImage = @"smallThumbnailImage";
NSString * const kWAFileSmallThumbnailURL = @"smallThumbnailURL";
NSString * const kWAFileSmallThumbnailFilePath = @"smallThumbnailFilePath";
...
NSString * const kWAFileDisplayingSmallThumbnail = @"displayingSmallThumbnail";
NSString * const kWAFileDisplayingThumbnail = @"displayingThumbnail";
