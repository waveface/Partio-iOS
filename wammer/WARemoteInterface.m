...
- (id) init {
  ...
  self.reachability = [Reachability reachabilityWithHostname:[self.engine.context.baseURL host]];
  [self.reachability startNotifier];
  
  [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleBaseURLChanged:) name:kWARemoteInterfaceContextDidChangeBaseURLNotification object:nil];
...
- (void)handleBaseURLChanged:(NSNotification *)note {
