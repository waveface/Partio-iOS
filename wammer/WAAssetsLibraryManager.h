 ...
 */
- (void)enumerateSavedPhotosSince:(NSDate *)sinceDate onProgess:(void (^)(NSArray *assets, NSDate *progressDate, BOOL *stop))onProgressBlock onComplete:(void(^)(NSDate *progressDate))onCompleteBlock onFailure:(void(^)(NSError *error))onFailureBlock;
